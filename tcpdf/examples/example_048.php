...
$tbl = <<<EOD
<table cellspacing="0" cellpadding="1" border="1" height="400">
    <tr height="20">
...
$tbl = <<<EOD
<table border="1" cellpadding="2" cellspacing="2" align="center" height="500" style="height:500px;">
 <tr height="2" style="height:2px;">
  <th style="height:2px;" colspan="3" height="2">NON-BREAKING ROWS</th>
 </tr>
 <tr  style="height:2px;" height="2">
  <td style="height:2px;" height="2">ROW 1<br />COLUMN 1</td>
  <td style="height:2px;" height="2">ROW 1<br />COLUMN 2</td>
  <td style="height:2px;"  height="2">ROW 1<br />COLUMN 3</td>
 </tr>
 <tr  style="height:2px;" height="2">
  <td style="height:2px;" height="2">ROW 2<br />COLUMN 1</td>
  <td style="height:2px;" height="2">ROW 2<br />COLUMN 2</td>
  <td style="height:2px;" height="2">ROW 2<br />COLUMN 3</td>
 </tr>
 <tr>
