...
if(isset($_POST['add'])) {
    ...
    $flat_given_on=$_POST['flat_given_on'];
    ...
    $query=mysqli_query($conn,"INSERT INTO flat_rental (flat_no,building_name,area,room,wing,area_sq_ft,user_name,phone,phone2,email,working_place,rent,Deposite,Family_members,family_members_name,current_meter_reading,flat_given_on,address,rent_due_date,from_date,adhar_card,pancard,lightbill,status,maintainence,amt_per_unit,photo,final_rent)
		        VALUES ('$flat_no','$building_name','$area','$room','$wing','$area_sq_ft','$user_name','$phone','$phone2','$email','$working_place','$rent','$Deposite','$Family_members','$family_members_name','$current_meter_reading','$flat_given_on','$address','$rent_due_date','$from_date','$adhar_card','$pancard','$lightbill','$status','$maintainence','$amt_per_unit','$photo','$final_rent')");
    if($query==1)
    {
        ...
        if($query1==1){
            mysqli_query($conn,"update rent_update_details set user_name='$user_name',phone='$phone',rent_from='$from_date',rent_due_date='$rent_due_date',rent_paid_date='$from_date',last_meter_reading='$current_meter_reading',per_unit_reading='$amt_per_unit',final_rent_amt='$final_rent',remain_amt='0' where flat_no='$flat_no' and wing='$wing' and building_name='$building_name'");
    ...
    <!--main content start-->
      ...
      <section class="wrapper">
       <?php 
         ...
         <div class="showback">            
                     <button data-toggle="modal" data-target="#add-modal" id="getUser" class="btn btn-sm btn-info"><i class="fa fa-edit"></i> Add Tenant</button>
            ...
            <div class="row mt1">
          		<div class="col-lg-12">
            		 ...
            		 <div class="col-lg-6"><a href="view-tenant-flat-details.php?building_name=<?php echo $building_name;?>&wing=<?php echo $wing;?>&b_id=<?php echo $id;?>"><button type="button" class="float-r back-btn btn btn-secondary btn-sm"><i class="fa fa-mail-reply-all"></i> Back To <?php echo $wing;?> Wing flats</button></a>
            		 </div>
            		 </div>
