       ...
       <li class="mt">
          ...
          <li class="sub-menu">
            ...
            <a class="active" href="javascript:;">
              <i class="fa fa-inr"></i>
              <span>Payment</span><label class="label pull-right"><i class="fa fa-angle-down" style="color:#404E67;"></i></label>
              </a>
            <ul class="sub">
              <li><a href="view_payment.php">Pay RTGS/Cash</a></li>
                     <li><a href="view_outstanding.php">Client Outstanding</a></li>
              <li><a href="view_company_outstanding.php">Company Outstanding</a></li>
              <li><a href="view_company_credit.php">Company Credit</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
            ...
            <ul class="sub">
              <li><a href="view_stock_invoice.php">Stock</a></li>
           ...
           <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="view_income_report.php">Invoice</a></li>
              <li><a href="view_stock_report.php">Stock</a></li>   
                <li><a href="view_outsanding_report.php">Client Outstanding Report</a></li>                       
            </ul>
          </li>
        </ul>
        <!-- sidebar menu end-->
...
if ($result->num_rows > 0) {
    ?>
     ...
     <tr>
                     	...
                     	<td  data-title="Name"><?php echo $row["flat_no"];  ?></td>
                     	<td data-title="Mobile"><?php echo $row["building_name"];  ?></td>
                     	<td data-title="Mobile"><?php echo $row["wing"];  ?></td>
                     	<td data-title="Mobile"><?php echo $row["user_name"];  ?></td>
                        <td data-title="Total"><?php echo $row["phone"];  ?></td>
                        <td data-title="Paid"><?php echo $row["rent"];  ?></td>
                        <td data-title="unpaid"><?php echo $row["rent_paid_date"];  ?></td>
  						  <td data-title="unpaid"><?php echo $row["current_meter_reading"];  ?></td>
		</tr>
