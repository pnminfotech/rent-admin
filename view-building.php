	...
	*/
    ...
    You could also use a data-* attribute and content for this. That way "bloats" the HTML, this way means you need to keep HTML and CSS in sync. Lea Verou has a clever way to handle with text-shadow.
		*/
		...
		#employeeList>tbody>tr>td:nth-of-type(3):after { content: "Area"; }
		#employeeList>tbody>tr>td:nth-of-type(4):after { content: "Total Flat"; }
		#employeeList>tbody>tr>td:nth-of-type(5):after { content: "Common Meter No"; }
		#employeeList>tbody>tr>td:nth-of-type(6):after { content: "Action"; }
       ...
       <button type="button" name="add" id="addEmployee" class="btn btn-success add-btn" >Add Building</button>
            ...
            <div class="row mt">
          		<div class="col-lg-12">
            		 ...
            		 <div class="col-lg-6"><h4>Building Details</h4></div>
				...
				<tr role="row">
					...
					<th role="columnheader">CommonMeter Number</th>				
    		...
    		<form method="post" id="employeeForm">
    			<div class="modal-content" >
					...
					<div class="item form-group">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-12 col-sm-12 label-align" for="first-name">Wing &amp; Total Flat<span class="required">*</span>
											</label>
                                             ...
                                             <table class="table table-bordered table-striped table-condensed" style="width:100%"" id="customFields">
                                            	 <tr>
                                                  ...
                                                  <script type="text/javascript">
													...
													<div class="item form-group">     
											<label class="col-form-label col-md-12 col-sm-12 label-align" for="first-name">Common Meter Number<span class="required">*</span></label>
															<div class="col-md-12 col-sm-12">
																<table
																	...
																	<tbody>
																		<tr id="1">
																			...
																			<td class="text-center"><input required
																				class="form-control" name="common_meter_no[]"
																				 type="text"
																				placeholder="Common Meter No"></td>
												...
												<div class="item form-group">
														<label class="col-form-label col-md-2 col-sm-2 label-align" for="first-name">Total Flat<span class="required"> : </span> <span id="weight22" style="font-family: fantasy;"></span>		</label>
...
$(document).ready(function(){
	$(".addCN").click(function(){
	  var counter = $("#customFields tbody tr").length;
	  var newId = counter + 0;
		$("#commonNo").append('<tbody><tr id="1" ><td class="append-table"> '+newId+ '<input type="hidden" value="'+newId+ '" id="1" name="sn[]" ></td><td class="text-center append-table"><input required  class="form-control" name="common_meter_no[]" type="text" placeholder="Common Meter No"></td><td class="append-table"> <a href="javascript:void(0);" class="remCF"> <span class="fa fa-2x fa-minus-square removeItem"></span></a></td></tr></tbody>');
	});
