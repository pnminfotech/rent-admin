...
if(isset($_POST['insert'])) {
  ...
  mysqli_query($conn,"INSERT INTO users (name,password)
       ...
       if(mysqli_affected_rows($conn) > 0){
           ...
           echo 'alert("Successfully Add Users")';
           echo '</script>';
       } else {
           echo "Ctegory NOT Added<br />";
          ...
          <div class="col-lg-12">
            ...
            <p style="color:#FF0000;"></p>
				...
				<div class="col-sm-6">
                 ...
                 <div class="form-send">
                 <button type="submit" value="submit" name="insert" class="btn btn-large  btn-theme btn-primary">Add User</button>
