				...
				<div class="col-lg-12">
					<div class="col-lg-6 col-md-6 col-sm-6">
                     ...
                     ?>
						...
						<a href="view-flat-wing.php?building_name=<?php echo $building_name;?>&b_id=<?php echo $id;?>"><button
								type="button" class="float-r back-btn btn btn-secondary btn-sm">
								<i class="fa fa-mail-reply-all"></i> Back To Wing </button></a>
					</div>
				</div>
...
?>
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 text-center mt-2  mb-2">
									<a href='view-flat-main-info.php?flat_no=<?php echo $row["flat_no"];?>&building_name=<?php echo $row["building_name"]; ?>&b_id=<?php echo $row["b_id"]; ?>&wing=<?php echo $row["wing"]; ?>'> 
									<button type="button" class="high btn btn-sm btn-success new-width btn-building ">
										<i class="fa fa-building building-icon <?php echo $row["availonrent"]; ?>" aria-hidden="true"></i>
									</button>
									<br> <span class="font-weight-bold f-16"><?php echo $row["flat_no"]; ?></span><br>
									<span><?php echo $row["building_name"]; ?> -<?php echo $row["wing"]; ?> wing </span></a>
								</div>
								<?php }}?>
</div>
 					 </div>
