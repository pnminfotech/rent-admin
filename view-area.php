...
<script src="ajax-js/area-data.js"></script>	
<style>
/*
	...
	*/
    ...
    You could also use a data-* attribute and content for this. That way "bloats" the HTML, this way means you need to keep HTML and CSS in sync. Lea Verou has a clever way to handle with text-shadow.
		*/
		...
		#employeeList>tbody>tr>td:nth-of-type(3):after { content: "Action"; }
  ...
  <a href="home.php" class="logo"><span>Rent</span></a>
    ...
    <!--main content start-->
      ...
      <section class="wrapper">
       ...
       <button type="button" name="add" id="addEmployee" class="btn btn-success add-btn">Add Area</button>&nbsp;&nbsp;&nbsp;
                       <a href="view-building.php"><button type="button" class="btn btn-success add-btn" >Building</button></a>
          </div>
    		...
    		<form method="post" id="employeeForm">
    			<div class="modal-content">
					...
					<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Area Name <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6">
												<input type="text" id="area" name="area" required="required" class="form-control " Placeholder="Area Name">
											</div>
