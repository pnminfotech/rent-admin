...
._bg3,._bg4,._bg5,._bg6,._bg7,._bg8,._bg9,._bg10,._bg11,._bg12{
color:red;
}
._bg13,._bg14,._bg15,._bg16,._bg17,._bg18,._bg19,._bg20,._bg21,._bg22,._bg23,._bg24{
color:red;
}
._bg1_btn{
				...
				<div class="col-lg-12">
				 <?php
					...
					<div class="col-lg-6 col-md-6 col-sm-6  mt-2">
						<div class="float-btn">
						<a
								href="view-rent-wing.php?building_name=<?php echo $building_name;?>&b_id=<?php echo $id;?>"><button
									type="button" class=" back-btn btn btn-secondary btn-sm">
									<i class="fa fa-mail-reply-all"></i> Back To Wing
								</button></a>
						</div>
					</div>
				</div>
...
$id=$_REQUEST['b_id'];
$wing=$_REQUEST['wing'];
$sql = "select * from rent_update_details where building_name='$building_name' and b_id=$id and wing='$wing'";
								...
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 text-center mt-2  mb-2">
										<?php 
											...
											$diff11=substr($diff,-2);
											    ?>
									<a href='view-rent-flat-pay-info.php?flat_no=<?php echo $row["flat_no"];?>&building_name=<?php echo $row["building_name"]; ?>&b_id=<?php echo $row["b_id"]; ?>&wing=<?php echo $row["wing"]; ?>'> 
									<button type="button" class="high btn btn-sm btn-success new-width btn-building">
										<i class="fa fa-building building-icon _bg<?php echo $diff11; ?>" aria-hidden="true"></i>
									</button>
