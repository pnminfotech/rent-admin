...
?>
								<div class="col-lg-3 text-center mt-2  mb-2">
									<a href='view-flat-wing.php?building_name=<?php echo $row["building_name"]; ?>&b_id=<?php echo $row["id"]; ?>'> 
									...
									<br> <span class="font-weight-bold f-16"><?php echo $row["building_name"]; ?></span><br>
									<span><?php echo $row["area"]; ?> </span></a>
								</div>
								<?php }}?>
